![CI](https://github.com/Hoamai20041509/K3-Day12-2A202601317-TranThiHoaMai/actions/workflows/ci.yml/badge.svg)

# K3 — Ngày 12: Hạ Tầng Cloud & Deployment (9h00–13h00)

Đưa một AI agent từ `localhost:8001` lên một địa chỉ công khai mà người khác
